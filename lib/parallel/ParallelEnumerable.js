...
function aggregate(source, seedOrFunc, func, resultSelector) {
    if (resultSelector) {
        ...
        return ParallelEnumerablePrivate.aggregate_3(source, seedOrFunc, func, resultSelector);
    }
    else if (func) {
        return ParallelEnumerablePrivate.aggregate_2(source, seedOrFunc, func);
    }
    else {
        return ParallelEnumerablePrivate.aggregate_1(source, seedOrFunc);
    }
}
...
function allAsync(source, predicate) {
    return __awaiter(this, void 0, void 0, function* () {
        const nextIter = ParallelEnumerablePrivate.nextIterationAsync(source, (x) => __awaiter(this, void 0, void 0, function* () {
...
function average(source, selector) {
    if (selector) {
        return ParallelEnumerablePrivate.average_2(source, selector);
    }
    else {
        return ParallelEnumerablePrivate.average_1(source);
    }
}
...
function each(source, action) {
    return new BasicParallelEnumerable_1.BasicParallelEnumerable(ParallelEnumerablePrivate.nextIteration(source, (x) => {
        action(x);
        return x;
    }));
}
...
function eachAsync(source, action) {
    return new BasicParallelEnumerable_1.BasicParallelEnumerable(ParallelEnumerablePrivate.nextIterationAsync(source, (x) => __awaiter(this, void 0, void 0, function* () {
        yield action(x);
        return x;
    })));
}
...
function firstAsync(source, predicate) {
    return __awaiter(this, void 0, void 0, function* () {
        const data = yield ParallelEnumerablePrivate.toArray(source);
...
function select(source, key) {
    if (typeof key === "string") {
        return new BasicParallelEnumerable_1.BasicParallelEnumerable(ParallelEnumerablePrivate.nextIteration(source, (x) => x[key]));
    }
    else {
        return new BasicParallelEnumerable_1.BasicParallelEnumerable(ParallelEnumerablePrivate.nextIteration(source, key));
    }
}
...
function selectMany(source, selector) {
    const generator = () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (typeof selector === "string") {
            values = yield ParallelEnumerablePrivate.nextIteration(source, (x) => x[selector]);
        }
        else {
            values = yield ParallelEnumerablePrivate.nextIteration(source, selector);
        }
        const valuesArray = [];
        switch (values.type) {
            case 0 /* PromiseToArray */:
...
function selectManyAsync(source, selector) {
    const generator = () => __awaiter(this, void 0, void 0, function* () {
        const values = yield ParallelEnumerablePrivate.nextIterationAsync(source, selector);
        const valuesArray = [];
        switch (values.type) {
            case 0 /* PromiseToArray */:
                {
...
function singleAsync(source, predicate) {
    return __awaiter(this, void 0, void 0, function* () {
        const results = yield ParallelEnumerablePrivate.toArray(source);
        let hasValue = false;
...
function sum(source, selector) {
    if (selector) {
        return ParallelEnumerablePrivate.sum_2(source, selector);
    }
    else {
        return ParallelEnumerablePrivate.sum_1(source);
    }
}
exports.sum = sum;
...
var ParallelEnumerablePrivate_1 = require("./ParallelEnumerablePrivate");
exports.toArray = ParallelEnumerablePrivate_1.toArray;
