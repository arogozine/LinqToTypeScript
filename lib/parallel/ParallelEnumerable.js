...
class BasicParallelEnumerable {
    ...
    contains(value, comparer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (values.type) {
                case "PromiseToArray":
                    {
                        const data = yield values.data();
                        return data.some((x) => x);
                    }
                case "ArrayOfPromises":
                    {
                        const data = yield Promise.all(values.data());
                        return data.some((x) => x);
                    }
                case "PromiseOfPromises":
                    {
                        const data = yield Promise.all(yield values.data());
                        return data.some((x) => x);
                    }
            }
        });
    ...
    elementAt(index) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (dataFunc.type) {
                ...
                case "PromiseOfPromises":
                    return dataFunc.data().then((values) => __awaiter(this, void 0, void 0, function* () {
                        if (index >= values.length) {
                            throw new shared_1.ArgumentOutOfRangeException("index");
                        }
                        else {
    ...
    first_1() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (dataFunc.type) {
                case "PromiseToArray":
                    {
                        const values = yield dataFunc.data();
                        if (values.length === 0) {
                ...
                case "PromiseOfPromises":
                    {
                        const promises = yield dataFunc.data();
                        if (promises.length === 0) {
                            throw new shared_1.InvalidOperationException(shared_1.ErrorString.NoElements);
                        }
                        else {
    ...
    selectMany(selector) {
        const data = () => __awaiter(this, void 0, void 0, function* () {
            ...
            switch (values.type) {
                case "PromiseToArray":
                    {
                        for (const outer of yield values.data()) {
    ...
    single_1() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (dataFunc.type) {
                case "PromiseToArray":
                    {
                        const results = yield dataFunc.data();
                        if (results.length > 1) {
    ...
    skip(count) {
        ...
        switch (dataFunc.type) {
            case "PromiseToArray":
                {
                    const data = () => __awaiter(this, void 0, void 0, function* () { return (yield dataFunc.data()).slice(count); });
                    return new BasicParallelEnumerable({
                        type: "PromiseToArray",
                        data,
                    });
            ...
            case "PromiseOfPromises":
                {
                    const data = () => __awaiter(this, void 0, void 0, function* () {
                        const dataInner = yield dataFunc.data();
    ...
    toArray() {
        ...
        switch (dataFunc.type) {
            ...
            case "PromiseOfPromises":
                return (() => __awaiter(this, void 0, void 0, function* () {
                    const data = yield dataFunc.data();
    ...
    nextIteration(onfulfilled) {
        ...
        switch (dataFunc.type) {
            ...
            case "PromiseOfPromises":
                {
                    const data = () => __awaiter(this, void 0, void 0, function* () {
                        const previousData = yield dataFunc.data();
                        const newPromises = new Array(previousData.length);
                        for (let i = 0; i < previousData.length; i++) {
                            newPromises[i] = previousData[i].then(onfulfilled);
                        }
