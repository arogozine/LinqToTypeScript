...
function allAsync(source, predicate) {
    return __awaiter(this, void 0, void 0, function* () {
        const nextIter = nextIterationAsync(source, (x) => __awaiter(this, void 0, void 0, function* () {
...
function each(source, action) {
    return new BasicParallelEnumerable_1.BasicParallelEnumerable(nextIteration(source, (x) => {
        action(x);
        return x;
    }));
}
...
function eachAsync(source, action) {
    return new BasicParallelEnumerable_1.BasicParallelEnumerable(nextIterationAsync(source, (x) => __awaiter(this, void 0, void 0, function* () {
        yield action(x);
        return x;
    })));
}
...
function select(source, key) {
    if (typeof key === "string") {
        return new BasicParallelEnumerable_1.BasicParallelEnumerable(nextIteration(source, (x) => x[key]));
    }
    else {
        return new BasicParallelEnumerable_1.BasicParallelEnumerable(nextIteration(source, key));
    }
}
...
function selectMany(source, selector) {
    const generator = () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (typeof selector === "string") {
            values = yield nextIteration(source, (x) => x[selector]);
        }
        else {
            values = yield nextIteration(source, selector);
        }
        const valuesArray = [];
        switch (values.type) {
            case 0 /* PromiseToArray */:
...
function selectManyAsync(source, selector) {
    const generator = () => __awaiter(this, void 0, void 0, function* () {
        const values = yield nextIterationAsync(source, selector);
        const valuesArray = [];
        switch (values.type) {
            case 0 /* PromiseToArray */:
                {
...
function nextIterationAsync(source, onfulfilled) {
    const dataFunc = source.dataFunc;
    switch (dataFunc.type) {
        case 0 /* PromiseToArray */:
            {
