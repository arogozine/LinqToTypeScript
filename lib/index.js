...
const initialize_2 = require("./parallel/initialize");
const initialize_3 = require("./sync/initialize");
initialize_3.initializeTypes();
initialize_1.initializeAsyncTypes();
initialize_2.initializeParallelTypes();
// Shared Interfacess
