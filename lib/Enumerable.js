"use strict";
const Linq = require("./TypesAndHelpers");
...
class Enumerable {
    ...
    static contains(source, value, comparer = Linq.StrictEqualityComparer) {
        for (let item of source) {
    ...
    static distinct(source, comparer = Linq.StrictEqualityComparer) {
        function* iterator() {
    ...
    static except(first, second, comparer = Linq.EqualityComparer) {
        function* iterator() {
    ...
    static GroupBy_2(source, keySelector, resultSelector, comparer = Linq.StrictEqualityComparer) {
        function* iterator() {
    ...
    static GroupBy_3(source, keySelector, elementSelector, resultSelector, comparer = Linq.StrictEqualityComparer) {
        function* iterator() {
    ...
    static intersect(first, second, comparer = Linq.StrictEqualityComparer) {
        function* iterator() {
    ...
    static pluck(source, propertyName) {
        function* iterator() {
            for (let value of source) {
    ...
    static orderBy(source, keySelector, comparer) {
        ...
        return new OrderedEnumerable(lazyMap, comparer);
    }
    ...
    static sequenceEquals(first, second, comparer = Linq.StrictEqualityComparer) {
