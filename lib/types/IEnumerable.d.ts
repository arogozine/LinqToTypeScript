import { IAsyncEnumerable, IAsyncEqualityComparer, IComparer, IEqualityComparer, IGrouping, InferType, IOrderedAsyncEnumerable, IOrderedEnumerable, IParallelEnumerable, OfType, SelectorKeyType } from "./";
export interface IEnumerable<TSource> extends Iterable<TSource> {
    ...
    groupBy<TKey extends SelectorKeyType>(keySelector: (x: TSource) => TKey): IEnumerable<IGrouping<TKey, TSource>>;
    groupBy<TKey>(keySelector: (x: TSource) => TKey, comparer: IEqualityComparer<TKey>): IEnumerable<IGrouping<TKey, TSource>>;
    groupByAsync<TKey extends SelectorKeyType>(keySelector: (x: TSource) => Promise<TKey>): IAsyncEnumerable<IGrouping<TKey, TSource>>;
    ...
    groupByWithSel<TElement, TKey extends SelectorKeyType>(keySelector: ((x: TSource) => TKey), elementSelector: (x: TSource) => TElement): IEnumerable<IGrouping<TKey, TElement>>;
