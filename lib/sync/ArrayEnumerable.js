...
class ArrayEnumerable extends Array {
    ...
    containsAsync(value, comparer) {
        return Enumerable_1.Enumerable.containsAsync(this, value, comparer);
    }
    count(predicate) {
        if (predicate) {
            let count = 0;
    ...
    distinctAsync(comparer) {
        return Enumerable_1.Enumerable.distinctAsync(this, comparer);
    }
    elementAt(index) {
    ...
    exceptAsync(second, comparer) {
        return Enumerable_1.Enumerable.exceptAsync(this, second, comparer);
    }
    first(predicate) {
        if (predicate) {
    ...
    groupByAsync(keySelector, comparer) {
        return Enumerable_1.Enumerable.groupByAsync(this, keySelector, comparer);
    }
    ...
    intersectAsync(second, comparer) {
        return Enumerable_1.Enumerable.intersectAsync(this, second, comparer);
    }
