...
export interface IEnumerable<TSource> extends Iterable<TSource> {
    ...
    orderBy(predicate: KeySelector<TSource>, comparer?: IComparer<InferKey<typeof predicate>>): IOrderedEnumerable<TSource>;
    ...
    orderByDescending(predicate: KeySelector<TSource>, comparer?: IComparer<InferKey<typeof predicate>>): IOrderedEnumerable<TSource>;
