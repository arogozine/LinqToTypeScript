                ...
                try {
                    for (var source_17 = __asyncValues(source), source_17_1; source_17_1 = yield __await(source_17.next()), !source_17_1.done;) {
                        ...
                        if (item[Symbol.asyncIterator] !== undefined) {
                            yield __await(yield* __asyncDelegator(__asyncValues(shallow ? item : iterator(item))));
                        }
                        else {
                            yield item;
                        }
    ...
    static test() {
        return function () {
            return __asyncGenerator(this, arguments, function* () {
                yield yield __await(new Promise((resolve) => setTimeout(() => resolve(1), 100)));
                yield yield __await(new Promise((resolve) => setTimeout(() => resolve(2), 100)));
                yield yield __await(new Promise((resolve) => setTimeout(() => resolve(3), 100)));
            });
        };
    }
    constructor() { }
