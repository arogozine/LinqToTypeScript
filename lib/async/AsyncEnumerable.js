...
class BasicAsyncEnumerable {
    ...
    asParallel() {
        return parallel_1.ParallelEnumerable.from(0, () => this.toArray());
    }
...
class AsyncEnumerable {
    ...
    static singleOrDefault_1(source) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let singleValue = null;
            try {
                for (var source_30 = __asyncValues(source), source_30_1; source_30_1 = yield source_30.next(), !source_30_1.done;) {
                    const value = yield source_30_1.value;
                    if (hasValue === true) {
                        throw new shared_1.InvalidOperationException(shared_1.ErrorString.MoreThanOneElement);
                    }
                    else {
    ...
    static singleOrDefault_2(source, predicate) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let singleValue = null;
            try {
                for (var source_31 = __asyncValues(source), source_31_1; source_31_1 = yield source_31.next(), !source_31_1.done;) {
                    const value = yield source_31_1.value;
                    if (predicate(value)) {
                        if (hasValue === true) {
                            throw new shared_1.InvalidOperationException(shared_1.ErrorString.MoreThanOneElement);
                        }
            ...
            return __asyncGenerator(this, arguments, function* iterator_17() {
                ...
                try {
                    for (var source_34 = __asyncValues(source), source_34_1; source_34_1 = yield __await(source_34.next()), !source_34_1.done;) {
                        const item = yield __await(source_34_1.value);
                        if (skip === false) {
                            yield item;
                        }
            ...
            return __asyncGenerator(this, arguments, function* iterator_18() {
                try {
                    for (var source_35 = __asyncValues(source), source_35_1; source_35_1 = yield __await(source_35.next()), !source_35_1.done;) {
                        const item = yield __await(source_35_1.value);
                        if (typeCheck(item)) {
                            yield item;
                        }
                    }
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    for (var source_36 = __asyncValues(source), source_36_1; source_36_1 = yield source_36.next(), !source_36_1.done;) {
                        const item = yield source_36_1.value;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_43 = __asyncValues(source), source_43_1; source_43_1 = yield source_43.next(), !source_43_1.done;) {
                    const item = yield source_43_1.value;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_44 = __asyncValues(source), source_44_1; source_44_1 = yield source_44.next(), !source_44_1.done;) {
                    const item = yield source_44_1.value;
            ...
            return __asyncGenerator(this, arguments, function* iterator_22() {
                ...
                try {
                    for (var source_45 = __asyncValues(source), source_45_1; source_45_1 = yield __await(source_45.next()), !source_45_1.done;) {
                        const value = yield __await(source_45_1.value);
                        values.push(value);
                    }
                }
    ...
    static sum_2(source, selector) {
        return __awaiter(this, void 0, void 0, function* () {
            let sum = 0;
            try {
                for (var source_47 = __asyncValues(source), source_47_1; source_47_1 = yield source_47.next(), !source_47_1.done;) {
                    const value = yield source_47_1.value;
                    sum += selector(value);
                }
            }
                ...
                try {
                    if (source_47_1 && !source_47_1.done && (_a = source_47.return)) yield _a.call(source_47);
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_51 = __asyncValues(source), source_51_1; source_51_1 = yield source_51.next(), !source_51_1.done;) {
                    const item = yield source_51_1.value;
                    array.push(item);
                }
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_54 = __asyncValues(source), source_54_1; source_54_1 = yield source_54.next(), !source_54_1.done;) {
                    const item = yield source_54_1.value;
                    set.add(item);
                }
            }
                ...
                for (const source of [first, second]) {
                    try {
                        for (var source_55 = __asyncValues(source), source_55_1; source_55_1 = yield __await(source_55.next()), !source_55_1.done;) {
                            const value = yield __await(source_55_1.value);
                            let exists = false;
    ...
    static where_1(source, predicate) {
        function iterator() {
            return __asyncGenerator(this, arguments, function* iterator_28() {
                try {
                    for (var source_56 = __asyncValues(source), source_56_1; source_56_1 = yield __await(source_56.next()), !source_56_1.done;) {
                        const item = yield __await(source_56_1.value);
                        if (predicate(item) === true) {
                            yield item;
                        }
                    }
                    ...
                    try {
                        if (source_56_1 && !source_56_1.done && (_a = source_56.return)) yield __await(_a.call(source_56));
                    }
    ...
    static where_2(source, predicate) {
        function iterator() {
            return __asyncGenerator(this, arguments, function* iterator_29() {
                let i = 0;
                try {
                    for (var source_57 = __asyncValues(source), source_57_1; source_57_1 = yield __await(source_57.next()), !source_57_1.done;) {
                        const item = yield __await(source_57_1.value);
                    ...
                    try {
                        if (source_57_1 && !source_57_1.done && (_a = source_57.return)) yield __await(_a.call(source_57));
                    }
    ...
    static whereAsync_1(source, predicate) {
        function iterator() {
            return __asyncGenerator(this, arguments, function* iterator_30() {
                try {
                    for (var source_58 = __asyncValues(source), source_58_1; source_58_1 = yield __await(source_58.next()), !source_58_1.done;) {
                        const item = yield __await(source_58_1.value);
                    ...
                    try {
                        if (source_58_1 && !source_58_1.done && (_a = source_58.return)) yield __await(_a.call(source_58));
                    }
    ...
    static whereAsync_2(source, predicate) {
        function iterator() {
            return __asyncGenerator(this, arguments, function* iterator_31() {
                let i = 0;
                try {
                    for (var source_59 = __asyncValues(source), source_59_1; source_59_1 = yield __await(source_59.next()), !source_59_1.done;) {
                        const item = yield __await(source_59_1.value);
                    ...
                    try {
                        if (source_59_1 && !source_59_1.done && (_a = source_59.return)) yield __await(_a.call(source_59));
                    }
