...
class AsyncEnumerable {
    ...
    static reverse(source) {
        function iterator() {
            return __asyncGenerator(this, arguments, function* iterator_29() {
                const values = [];
                try {
                    for (var source_63 = __asyncValues(source), source_63_1; source_63_1 = yield __await(source_63.next()), !source_63_1.done;) {
                        const value = yield __await(source_63_1.value);
                        values.push(value);
                    }
                }
                    ...
                    try {
                        if (source_63_1 && !source_63_1.done && (_a = source_63.return)) yield __await(_a.call(source_63));
                    }
    ...
    static sum_2(source, selector) {
        return __awaiter(this, void 0, void 0, function* () {
            let sum = 0;
            try {
                for (var source_65 = __asyncValues(source), source_65_1; source_65_1 = yield source_65.next(), !source_65_1.done;) {
                    const value = yield source_65_1.value;
                    sum += selector(value);
                }
            }
                ...
                try {
                    if (source_65_1 && !source_65_1.done && (_a = source_65.return)) yield _a.call(source_65);
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_72 = __asyncValues(source), source_72_1; source_72_1 = yield source_72.next(), !source_72_1.done;) {
                    const item = yield source_72_1.value;
                    array.push(item);
                }
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_77 = __asyncValues(source), source_77_1; source_77_1 = yield source_77.next(), !source_77_1.done;) {
                    const item = yield source_77_1.value;
                    set.add(item);
                }
            }
                ...
                for (const source of [first, second]) {
                    try {
                        for (var source_78 = __asyncValues(source), source_78_1; source_78_1 = yield __await(source_78.next()), !source_78_1.done;) {
                            const value = yield __await(source_78_1.value);
                            let exists = false;
                ...
                for (const source of [first, second]) {
                    try {
                        for (var source_79 = __asyncValues(source), source_79_1; source_79_1 = yield __await(source_79.next()), !source_79_1.done;) {
                            const value = yield __await(source_79_1.value);
                            let exists = false;
                            for (const resultValue of result) {
