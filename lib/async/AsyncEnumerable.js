...
class OrderedAsyncEnumerableDescending extends BasicAsyncEnumerable_1.BasicAsyncEnumerable {
    constructor(map, comparer) {
...
class AsyncEnumerable {
    ...
    static skip(source, count) {
        function iterator() {
            return __asyncGenerator(this, arguments, function* iterator_16() {
                let i = 0;
                try {
                    for (var source_41 = __asyncValues(source), source_41_1; source_41_1 = yield __await(source_41.next()), !source_41_1.done;) {
                        const item = yield __await(source_41_1.value);
                        if (i++ >= count) {
                            yield item;
                        }
                    }
                    ...
                    try {
                        if (source_41_1 && !source_41_1.done && (_a = source_41.return)) yield __await(_a.call(source_41));
                    }
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    for (var source_47 = __asyncValues(source), source_47_1; source_47_1 = yield source_47.next(), !source_47_1.done;) {
                        const item = yield source_47_1.value;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_48 = __asyncValues(source), source_48_1; source_48_1 = yield source_48.next(), !source_48_1.done;) {
                    const value = yield source_48_1.value;
                    last = value;
                }
            }
    ...
    static reverse(source) {
        function iterator() {
            return __asyncGenerator(this, arguments, function* iterator_25() {
                const values = [];
                try {
                    for (var source_60 = __asyncValues(source), source_60_1; source_60_1 = yield __await(source_60.next()), !source_60_1.done;) {
                        const value = yield __await(source_60_1.value);
                        values.push(value);
                    }
                }
                    ...
                    try {
                        if (source_60_1 && !source_60_1.done && (_a = source_60.return)) yield __await(_a.call(source_60));
                    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_61 = __asyncValues(source), source_61_1; source_61_1 = yield source_61.next(), !source_61_1.done;) {
                    const value = yield source_61_1.value;
                    sum += value;
                }
            }
    ...
    static take(source, amount) {
        function iterator() {
            return __asyncGenerator(this, arguments, function* iterator_26() {
                ...
                try {
                    for (var source_64 = __asyncValues(source), source_64_1; source_64_1 = yield __await(source_64.next()), !source_64_1.done;) {
                        const item = yield __await(source_64_1.value);
                        if (amountLeft-- === 0) {
                            break;
                        }
                        else {
                    ...
                    try {
                        if (source_64_1 && !source_64_1.done && (_a = source_64.return)) yield __await(_a.call(source_64));
                    }
    ...
    static toArray(source) {
        return __awaiter(this, void 0, void 0, function* () {
            const array = [];
            try {
                for (var source_69 = __asyncValues(source), source_69_1; source_69_1 = yield source_69.next(), !source_69_1.done;) {
                    const item = yield source_69_1.value;
                    array.push(item);
                }
            }
                ...
                try {
                    if (source_69_1 && !source_69_1.done && (_a = source_69.return)) yield _a.call(source_69);
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_70 = __asyncValues(source), source_70_1; source_70_1 = yield source_70.next(), !source_70_1.done;) {
                    const value = yield source_70_1.value;
        ...
        function iterator() {
            return __asyncGenerator(this, arguments, function* iterator_32() {
                ...
                for (const source of [first, second]) {
                    try {
                        for (var source_75 = __asyncValues(source), source_75_1; source_75_1 = yield __await(source_75.next()), !source_75_1.done;) {
                            const value = yield __await(source_75_1.value);
                            let exists = false;
                        ...
                        try {
                            if (source_75_1 && !source_75_1.done && (_a = source_75.return)) yield __await(_a.call(source_75));
                        }
            ...
            return __asyncGenerator(this, arguments, function* iterator_33() {
                try {
                    for (var source_76 = __asyncValues(source), source_76_1; source_76_1 = yield __await(source_76.next()), !source_76_1.done;) {
                        const item = yield __await(source_76_1.value);
                        if (predicate(item) === true) {
                            yield item;
                        }
                    }
            ...
            return __asyncGenerator(this, arguments, function* iterator_34() {
                ...
                try {
                    for (var source_77 = __asyncValues(source), source_77_1; source_77_1 = yield __await(source_77.next()), !source_77_1.done;) {
                        const item = yield __await(source_77_1.value);
