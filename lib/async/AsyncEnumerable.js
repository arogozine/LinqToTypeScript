        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_14 = __asyncValues(source), source_14_1; source_14_1 = yield source_14.next(), !source_14_1.done;) {
                    const _ = yield source_14_1.value;
                    count++;
                }
            }
            ...
            return __asyncGenerator(this, arguments, function* iterator_2() {
                ...
                try {
                    for (var source_17 = __asyncValues(source), source_17_1; source_17_1 = yield __await(source_17.next()), !source_17_1.done;) {
                        const item = yield __await(source_17_1.value);
    ...
    static distinctAsync(source, comparer) {
        function iterator() {
            return __asyncGenerator(this, arguments, function* iterator_3() {
                const distinctElements = [];
                try {
                    outerLoop: for (var source_18 = __asyncValues(source), source_18_1; source_18_1 = yield __await(source_18.next()), !source_18_1.done;) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_19 = __asyncValues(source), source_19_1; source_19_1 = yield source_19.next(), !source_19_1.done;) {
                    const item = yield source_19_1.value;
                    if (index === i++) {
                        return item;
                    }
                }
    ...
    static reverse(source) {
        function iterator() {
            return __asyncGenerator(this, arguments, function* iterator_27() {
                const values = [];
                try {
                    for (var source_62 = __asyncValues(source), source_62_1; source_62_1 = yield __await(source_62.next()), !source_62_1.done;) {
                        const value = yield __await(source_62_1.value);
                        values.push(value);
                    }
                }
                    ...
                    try {
                        if (source_62_1 && !source_62_1.done && (_a = source_62.return)) yield __await(_a.call(source_62));
                    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_71 = __asyncValues(source), source_71_1; source_71_1 = yield source_71.next(), !source_71_1.done;) {
                    const item = yield source_71_1.value;
                    array.push(item);
                }
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var source_76 = __asyncValues(source), source_76_1; source_76_1 = yield source_76.next(), !source_76_1.done;) {
                    const item = yield source_76_1.value;
                    set.add(item);
                }
            }
