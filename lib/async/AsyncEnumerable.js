...
function aggregate(source, seedOrFunc, func, resultSelector) {
    if (resultSelector) {
        ...
        return AsyncEnumerablePrivate.aggregate_3(source, seedOrFunc, func, resultSelector);
    }
    else if (func) {
        return AsyncEnumerablePrivate.aggregate_2(source, seedOrFunc, func);
    }
    else {
        return AsyncEnumerablePrivate.aggregate_1(source, seedOrFunc);
    }
}
...
function distinctAsync(source, comparer) {
    function iterator() {
        return __asyncGenerator(this, arguments, function* iterator_3() {
            ...
            const distinctElements = [];
            try {
                outerLoop: for (var source_10 = __asyncValues(source), source_10_1; source_10_1 = yield __await(source_10.next()), !source_10_1.done;) {
