 ...
 */
function asAsyncSortedKeyValuesSync(source, keySelector, ascending, comparer) {
    return __asyncGenerator(this, arguments, function* asAsyncSortedKeyValuesSync_1() {
        const map = yield __await(asAsyncKeyMapSync_1.asAsyncKeyMapSync(source, keySelector));
