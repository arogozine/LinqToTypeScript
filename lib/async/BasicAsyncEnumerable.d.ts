import { IAsyncEnumerable, IAsyncEqualityComparer, IAsyncParallel, IComparer, IEqualityComparer, IGrouping, InferType, IOrderedAsyncEnumerable, OfType, SelectorKeyType } from "../types";
/**
...
export declare class BasicAsyncEnumerable<TSource> implements IAsyncEnumerable<TSource> {
    ...
    selectManyAsync<Y>(selector: (x: TSource, index: number) => Promise<Iterable<Y>>): IAsyncEnumerable<Y>;
