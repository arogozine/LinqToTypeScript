 ...
 */
export function aggregate_1<TSource>(
...
export function aggregate_2<TSource, TAccumulate>(
    source: Iterable<TSource>,
    seed: TAccumulate,
...
export function aggregate_3<TSource, TAccumulate, TResult>(
    source: Iterable<TSource>,
    seed: TAccumulate,
...
export function any_1<TSource>(source: Iterable<TSource>): boolean {
...
export function any_2<TSource>(source: Iterable<TSource>, predicate: (x: TSource) => boolean): boolean {
...
export function average_2<TSource>(source: Iterable<TSource>, func: (x: TSource) => number): number {
    let value: number | undefined
    let count: number | undefined
    for (const item of source) {
...
export function count_1<T>(source: Iterable<T>): number {
    let count = 0
...
export function count_2<T>(source: Iterable<T>, predicate: (x: T) => boolean): number {
    let count = 0
    for (const value of source) {
