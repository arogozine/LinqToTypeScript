import { IComparer, IAsyncEnumerable, IOrderedAsyncEnumerable } from "../../types"
...
export const orderDescending = <TSource>(
    ...
    return OrderedAsyncEnumerable.generate<TSource, TSource>(source, (x: TSource) => x, false, comparer)
}