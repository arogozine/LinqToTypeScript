 ...
 */
export function fromAsync<TSource>(promises: Promise<TSource>[]): IAsyncEnumerable<TSource>
/**
 ...
 * @returns IAsyncEnumerable<T>
 */
export function fromAsync<TSource>(asyncIterable: () => AsyncIterableIterator<TSource>): IAsyncEnumerable<TSource>
export function fromAsync<TSource>(promisesOrIterable: Promise<TSource>[] | (() => AsyncIterableIterator<TSource>)) {
